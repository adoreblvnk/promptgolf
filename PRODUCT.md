...
Do not make PromptGolf feel like a generic prompt-education course, a chatbot wrapper, or a soft AI SaaS landing page. Avoid gradient text, excessive glassmorphism, side-stripe card accents, identical icon-card grids, over-rounded cards, vague AI hype, and any framing that grades prompt aesthetics instead of generated product behavior.

## Design Principles

1. Benchmark outputs, not vibes: every claim should connect to tests, scores, evidence, or generated app behavior.
