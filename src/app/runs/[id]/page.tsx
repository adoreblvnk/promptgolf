    ...
    <AppShell>
      <Section className="pb-5 pt-6 sm:pt-8">
        ...
        <div className="mt-3 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
          <div>
            <div className="font-mono text-[10px] uppercase tracking-[0.1em] text-ink-muted">Seeded reference · score fixed</div>
            <h1 className="mt-1.5 text-2xl font-semibold tracking-[-0.025em] text-ink">{run.label} prompt scorecard</h1>
            <p className="mt-1.5 max-w-3xl text-sm leading-6 text-ink-soft">{challenge?.title}: authored results demonstrate the scoring narrative under fixed reference conditions, not a fresh provider-backed run.</p>
          </div>
