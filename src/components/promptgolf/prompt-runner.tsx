    ...
    <form className="flex flex-col gap-4" action={submitPrompt}>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="max-w-3xl text-sm leading-6 text-ink-soft">
          Submits to the live execution path: Kimi builds the checkout artifact, Daytona serves the sandbox preview, TokenRouter drafts cache-friendly evaluator checks, and Playwright scores the generated app as-is. Seeded scorecards remain reference runs.
        </p>
        <button
          type="submit"
